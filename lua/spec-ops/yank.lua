...
function M.setup(opts)
	...
	local hl_ns = vim.api.nvim_create_namespace("spec-ops.highlight") --- @type integer
	...
	vim.keymap.set("n", "<Plug>(SpecOpsYankLine)", "<Plug>(SpecOpsYankOperator)<Plug>(SpecOpsYankLineObject)")
